#APP STREAMLIT : (commande : streamlit run ../P7_03_code_dashboard.py depuis le dossier python)
...
# plot graphe radar du client comparé aux crédits accordés/refusés pour un certain paramètre
...
st.set_page_config(layout='wide',
                   page_title="Dashboard Scoring Credit : Prédictions de scoring client et comparaison à l'ensemble des clients")
st.write("""
